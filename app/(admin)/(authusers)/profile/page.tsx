...
export default function ProfilePage() {
   ...
   const renderRow = (item: Order) => (
    <tr key={item.id} className="border-b border-gray-200 odd:bg-slate-300 text-sm hover:bg-[#EF3B3E4F] rounded-md">
    ...
    return (
      <div className="flex-1 p-4 flex flex-col gap-4 lg:flex-row">
        ...
        <div className="w-full lg:w-2/3">
          {/**User Info Card */}
          <div className='flex bg-white px-8 py-4 rounded-md'>
             <div className='w-1/3'>
          ...
          {/**Bottom1 */}
            <div className='px-2 py-4 rounded-md bg-white mt-4'>
              <p className='text-xs'>{UserData.companyprofile}</p>
            </div>
            <div className='mt-8 rounded=md'>
              <h1 className='bg-slate-200'>Previous Orders</h1>
